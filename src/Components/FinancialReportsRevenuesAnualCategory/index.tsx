...
const FinancialReportsRevenuesAnualCategory = () => {
  return (
    <Container>
      <ReportsHeader logo='' corporation="Inc Name" reportsName="Resumo anual de receitas por categoria" />
      <Filters>
        <Input type='text' />
        <Input type='text' />
        <Input type='text' />
...
export default FinancialReportsRevenuesAnualCategory;
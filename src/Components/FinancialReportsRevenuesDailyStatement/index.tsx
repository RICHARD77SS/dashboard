...
const FinancialReportsRevenuesDailyStatement = () => {
  return (
    <Container>
      <ReportsHeader logo='' corporation='Inc name' reportsName='Fluxo de caixa - Receitas Extrato diário' />
...
export default FinancialReportsRevenuesDailyStatement;
...
const FinancialReportsAnualCategory = () => {
  return (
    <Container>
      <ReportsHeader logo='' corporation="Inc Name" reportsName="Resumo anual por categoria" />
      <Filters>
        <Input type='text' />
        <Input type='text' />
        <Input type='text' />
...
export default FinancialReportsAnualCategory;
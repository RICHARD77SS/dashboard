...
const FinancialReportsProjections = () => {
  return (
    <Container>
      <ReportsHeader logo='' corporation='Inc name' reportsName='Fluxo de caixa - Projeção para:' />
...
export default FinancialReportsProjections;